  ...
  <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button @click="productModal.hide(), clearForm()" class="btn p-0"><font-awesome-icon icon="fa-solid fa-circle-xmark" /></button>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-gray-500" @click="t, clearForm()">清除</button>
        <button type="button" class="btn btn-outline-gray-500" data-bs-dismiss="modal" @click="clearForm()">取消</button>
